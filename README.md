...
Architecture B: **Sparse Detection + ByteTrack Propagation**
...
│
├── data/
│   ├── test_videos/          # Test clips (gitignored)
...
docker run --gpus all video-anon --url <video_url>
```
...
# With options
python anonymise.py --url <url> --output outputs/result.mp4 --detection-interval 5 --device auto
...
| # | Deliverable | Status |
|---|---|---|
| 1 | Pipeline code (`anonymise.py`) | ✅ Complete |
| 2 | Evaluation script (`evaluate.py`) | ✅ Complete |
| 3 | Benchmark report PDF | ✅ Complete |
| 4 | Architecture diagram | ✅ Complete |
| 5 | Model card | ✅ Complete |
| 6 | Reproducible environment (Docker/conda) | ✅ Complete |
...
| Challenge | Status |
|---|---|
| ONNX INT8 edge deployment (≥5 FPS CPU) | 🔲 Pending |
| Consistent identity tokens | 🔲 Pending |
